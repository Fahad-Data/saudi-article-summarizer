...
**جلب المقالات**
- استخدام crawler متقدم لجلب المقالات من Saudi Gazette
...
- الخلفي API: http://localhost:5000
...
**المعاملات:**
- اختياري: فرض تحديث المقالات `force_refresh` 
